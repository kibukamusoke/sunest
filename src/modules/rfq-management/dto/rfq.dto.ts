...
export class CreateRFQItemDto {
  ...
  @Transform(({ value }) => {
    // Handle undefined/null - return empty array
    ...
    if (typeof value === 'string') {
      ...
      try {
        ...
        // If parsed result is an object (not array), convert to array format
        if (
    ...
    // If it's an object (not array), convert to array format
...
export class CreateRFQDto {
  ...
  @ApiPropertyOptional({
    ...
    example:
      'We are seeking quotes for network equipment to upgrade our corporate infrastructure.',
  })
  @IsOptional()
  @IsString()
  description?: string;
