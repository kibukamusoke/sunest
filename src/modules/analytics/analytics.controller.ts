...
export class AnalyticsController {
  ...
  @ApiResponse({
    ...
    type: AnalyticsSessionResponseDto,
  })
  async createSession(
    @Body() createSessionDto: CreateAnalyticsSessionDto,
  ...
  @ApiResponse({
    ...
    type: [BusinessMetricResponseDto],
  })
  ...
  @Roles('SystemAdmin', 'MerchantAdmin', 'MerchantUser')
  async getMetrics(
    @Query() query: MetricListQueryDto,
  ...
  @ApiResponse({
    ...
    type: DataPointResponseDto,
  })
  @Roles('SystemAdmin', 'MerchantAdmin')
  async createDataPoint(
    @Body() createDataPointDto: CreateDataPointDto,
  ...
  async calculateMetric(
    ...
    await this.metricsService.calculateMetric(
      metricId,
      new Date(startDate),
      new Date(endDate),
    );
