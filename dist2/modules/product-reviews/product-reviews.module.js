...
const merchant_product_reviews_controller_1 = require("./merchant-product-reviews.controller");
...
exports.ProductReviewsModule = ProductReviewsModule = __decorate([
    (0, common_1.Module)({
        controllers: [product_reviews_controller_1.ProductReviewsController, merchant_product_reviews_controller_1.MerchantProductReviewsController],
