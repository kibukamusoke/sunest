...
export class PaymentProofResponseDto {
  ...
  @ApiPropertyOptional({ description: 'Public URL to the proof file' })
  url?: string;

  @ApiPropertyOptional({ description: 'Original filename' })
  filename?: string;

  @ApiPropertyOptional({ description: 'When the proof was uploaded' })
  uploadedAt?: Date;

  @ApiPropertyOptional({ description: 'User who uploaded the proof' })
  uploadedBy?: {
    id: string;
    displayName?: string;
    firstName?: string;
