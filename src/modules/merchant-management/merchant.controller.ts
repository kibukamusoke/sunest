...
export class MerchantController {
  ...
  @ApiOperation({
    ...
    description:
      'Submit a new merchant application for review. No authentication required.',
  })
  @ApiBody({
  ...
  @ApiOperation({
    ...
    description:
      'Check the status of a merchant application using the application ID.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      "Get the status of the authenticated user's merchant application.",
  })
  @ApiResponse({
    status: 200,
    description: 'Application status retrieved successfully',
  ...
  async getMyApplicationStatus(@Req() req): Promise<CheckApplicationStatusDto> {
  ...
  @ApiOperation({
    ...
    description:
      'Update a pending or rejected merchant application. Only allowed for PENDING or REJECTED applications.',
  })
  @ApiParam({
    name: 'id',
    description: 'Merchant application ID',
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all documents for a merchant application (public endpoint)',
  })
  @ApiParam({
    name: 'id',
    description: 'Merchant application ID',
  ...
  @ApiOperation({
    ...
    description:
      'Upload a supporting document for merchant application (public endpoint)',
  })
  @ApiParam({
    name: 'id',
    description: 'Merchant application ID',
  ...
  @ApiOperation({
    ...
    description:
      'Delete a document from merchant application (public endpoint)',
  })
  @ApiParam({
    name: 'id',
    description: 'Merchant application ID',
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all merchant applications with PENDING status. Requires System Admin role.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all merchants with filtering options. Requires System Admin role.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Approve a pending merchant application. Requires system:manage permission.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiBody({
    ...
    examples: {
      'standard-approval': {
        ...
        value: {
          approvalNotes:
            'All documents verified and business credentials confirmed.',
  ...
  async approveMerchant(
    ...
    return this.merchantService.approveMerchant(
      id,
      approvalDto,
      req.user.userId,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Reject a pending merchant application. Requires system:manage permission.',
  })
  @ApiParam({
    name: 'id',
    ...
    examples: {
      'incomplete-docs': {
        ...
        value: {
          ...
          rejectionNotes:
            'Business license document is missing or expired. Please submit a current license.',
          canReapply: true,
      ...
      'failed-verification': {
        ...
        value: {
          ...
          rejectionNotes:
            'Unable to verify business credentials with provided information.',
          canReapply: false,
        },
      },
    },
  ...
  async rejectMerchant(
    ...
    return this.merchantService.rejectMerchant(
      id,
      rejectionDto,
      req.user.userId,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Get the profile of the merchant associated with the authenticated user. Requires Merchant Admin role.',
  })
  @ApiResponse({
    status: 200,
  ...
  async getMerchantProfile(@Req() req): Promise<MerchantProfileDto> {
    ...
    if (!userMerchants || userMerchants.length === 0) {
      throw new HttpException(
        'User not associated with any merchant',
  ...
  @ApiOperation({
    ...
    description:
      'Update the merchant profile. Requires merchant:manage permission.',
  })
  @ApiBody({
    ...
    examples: {
      'profile-update': {
        ...
        value: {
          ...
          description:
            'Premium electronic components supplier with 24/7 support',
  ...
  @ApiOperation({
    ...
    description:
      'Update any merchant information by ID. Requires system:manage permission.',
  })
  @ApiParam({
    name: 'id',
  ...
  // ==================== TEAM MANAGEMENT ====================
  // NOTE: Team endpoints must come before @Get(':id') to avoid route conflicts
  ...
  async getTeamStats(@Req() req): Promise<TeamStatsDto> {
    // Get merchant ID from user's merchant associations
    const userMerchants = req.user.merchants;
    if (!userMerchants || userMerchants.length === 0) {
      throw new HttpException(
  ...
  async inviteTeamMember(
    ...
    // For now, get the first merchant - in a real app, there might be logic to select the primary merchant
    const merchantId = userMerchants[0].id;
    return this.merchantService.inviteTeamMember(
      merchantId,
      inviteDto,
      req.user.userId,
    );
  ...
  async updateTeamMember(
    ...
    // For now, get the first merchant - in a real app, there might be logic to select the primary merchant
    const merchantId = userMerchants[0].id;
    return this.merchantService.updateTeamMember(
      merchantId,
      userId,
      updateDto,
      req.user.userId,
  ...
  async removeTeamMember(
    ...
    // For now, get the first merchant - in a real app, there might be logic to select the primary merchant
    const merchantId = userMerchants[0].id;
    return this.merchantService.removeTeamMember(
      merchantId,
      userId,
      removeDto,
      req.user.userId,
  ...
  @Post('team/:userId/resend-invitation')
  @UseGuards(JwtAuthGuard, RolesGuard)
  @MerchantAdmin()
  @ApiBearerAuth()
  @ApiOperation({
  ...
  async resendInvitation(
    ...
    // For now, get the first merchant - in a real app, there might be logic to select the primary merchant
    const merchantId = userMerchants[0].id;
    return this.merchantService.resendInvitation(
      merchantId,
      userId,
      req.user.userId,
    );
  ...
  @ApiOperation({
    ...
    description:
      'Get detailed merchant information by ID. Requires System Admin role.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Upload a supporting document for merchant verification (SSM, business license, etc.)',
  })
  @ApiParam({
    name: 'id',
    description: 'Merchant ID',
  ...
  @ApiOperation({
    ...
    description:
      'Update the verification status of a merchant document (Admin only)',
  })
  @ApiParam({
    name: 'documentId',
  ...
  async deleteMerchantDocument(
    ...
    return this.merchantDocumentService.deleteDocument(
      documentId,
      req.user.userId,
    );
  }
    ...
    schema: {
      ...
      properties: {
        url: {
          ...
          example:
            'https://storage.example.com/files/document.pdf?signature=...',
        },
        filename: {
          type: 'string',
