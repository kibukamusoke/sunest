...
export class ShipmentResponseDto {
  ...
  @ApiPropertyOptional({ description: 'Courier company name (manual)' })
  courierCompanyName?: string;

  @ApiPropertyOptional({ description: 'Tracking URL (manual)' })
  trackingUrl?: string;

  @ApiPropertyOptional({ description: 'Shipment notes (manual)' })
  notes?: string;
