...
export class SearchDiscoveryController {
  ...
  @ApiOperation({
    ...
    description:
      'Comprehensive product search with full-text search, filtering, sorting, and pagination capabilities',
  })
  @ApiResponse({
  ...
  @ApiOperation({
    ...
    description:
      'Fast search for instant results and auto-complete functionality',
  })
  @ApiQuery({
    name: 'q',
  ...
  @ApiOperation({
    ...
    description:
      'Search multiple products by SKU for procurement and inventory management',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiOperation({
    ...
    description:
      'Get intelligent search suggestions for auto-complete and search assistance',
  })
  @ApiResponse({
    status: HttpStatus.OK,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve comprehensive search analytics and insights for business intelligence',
  })
  @ApiQuery({
    name: 'startDate',
  ...
  async trackProductClick(
    ...
    const userId = req.user?.userId;
    const sessionId =
      trackingData.sessionId || req.sessionID || `session-${Date.now()}`;
  ...
  async getPopularSearchTerms(
    ...
    @Query('period', new DefaultValuePipe(AnalyticsPeriod.WEEK))
