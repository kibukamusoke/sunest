...
class User {
  ...
  @override
  String toString() => 'User[id=$id, email=$email, displayName=$displayName, avatar=$avatar, isActive=$isActive, emailVerified=$emailVerified, provider=$provider, providerId=$providerId, roles=$roles, files=$files, createdAt=$createdAt, updatedAt=$updatedAt]';
