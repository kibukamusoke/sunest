...
export class OrderFulfillmentController {
    ...
    async createOrder(
        ...
        return this.orderFulfillmentService.createOrder(
            createOrderDto,
            req.user.userId,
        );
    }
    ...
    async listOrders(
        ...
        return this.orderFulfillmentService.listOrders(
            filterDto,
            req.user.userId,
            req.user.roles,
        );
    ...
    @ApiOperation({
        ...
        description:
            'Retrieve detailed order information including items, fulfillments, and shipments',
    })
    @ApiResponse({
        status: 200,
    ...
    async getOrderById(
        ...
        return this.orderFulfillmentService.getOrderById(
            id,
            req.user.userId,
            req.user.roles,
        );
    ...
    async updateOrder(
        ...
        return this.orderFulfillmentService.updateOrder(
            id,
            updateOrderDto,
            req.user.userId,
            req.user.roles,
    ...
    @ApiOperation({
        ...
        description:
            'Attach a payment proof file (uploaded via Storage presigned flow) to an order and optionally update payment status',
    })
    @ApiResponse({
        status: 200,
    ...
    async uploadPaymentProof(
        ...
        return this.orderFulfillmentService.uploadPaymentProof(
            id,
            req.user.userId,
            req.user.roles,
            dto,
    ...
    async cancelOrder(
        ...
        return this.orderFulfillmentService.cancelOrder(
            id,
            reason,
            req.user.userId,
        );
    ...
    async createFulfillment(
        ...
        return this.orderFulfillmentService.createFulfillment(
            createFulfillmentDto,
            req.user.userId,
        );
    }
    ...
    async assignFulfillment(
        ...
        return this.orderFulfillmentService.assignFulfillment(
            id,
            assignDto,
            req.user.userId,
        );
    ...
    async createShipment(
        ...
        return this.orderFulfillmentService.createShipment(
            createShipmentDto,
            req.user.userId,
        );
    }
    ...
    async markShipmentShipped(
        ...
        return this.orderFulfillmentService.markShipmentShipped(
            id,
            trackingNumber,
            req.user.userId,
        );
    ...
    @ApiOperation({
        ...
        description:
            'Update shipment fields such as status, tracking number, and delivery timestamps',
    })
    @ApiResponse({
        status: 200,
    ...
    async updateShipment(
        ...
        return this.orderFulfillmentService.updateShipment(
            id,
            updateShipmentDto,
            req.user.userId,
        );
    ...
    async createInvoice(
        ...
        return this.orderFulfillmentService.createInvoice(
            createInvoiceDto,
            req.user.userId,
        );
    }
